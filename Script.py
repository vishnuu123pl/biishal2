...
sᴇɴᴅ ᴍᴇ ᴀɴʏ sᴇʀɪal ɴᴀᴍᴇ ᴀɴᴅ sᴇᴇ ᴍʏ ᴍᴀɢɪᴄ..✨</blockquote>
<blockquote>ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ 🤞🏻</blockquote>

ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/Mallu_adminbot'>Mallu Admin</a>
</b>"""
...
🙏🏻 ᴍʏ ᴄʀᴇᴀᴛᴏʀ : MALLU ADMIN
🤡 ᴍʏ ᴍᴀɴᴀɢᴇʀ : <a href="https://telegram.me/Mallu_adminbot">ʙɪɪsᴀʟ</a>
🧑🏻‍💻 ʀᴇᴘᴏ : <a href="https://telegram.me/Mallu_adminbot">CONTACT</a>
</b>"""
...
👇CLICK HERE TO GET CORRECT SERIAL NAMES 👇
https://t.me/c/2014811421/458977""
...
MALAYALAM👇
ആദ്യം ചെയ്യേണ്ടത് : നിങ്ങൾക്ക് ഇഷ്ടമുള്ള പ്ലാൻസ് സെലക്ട് ചെയ്ത് അതിന്റെ തുക ഈ <code>haridevpm24@okaxis</code> UPI ID യിലേക്ക് അയക്കുക. 

രണ്ടാമത് ചെയ്യേണ്ടത് : ഞങ്ങൾ നടത്തിയ ഇടപാടിന്റെ screen shot ഈ @Mallu_adminbot അക്കൗണ്ടിലേക്ക് അയച്ചുകൊടുക്കുക 

അല്ലെങ്കിൽ ചെയ്യേണ്ടത് : ഇടപാടിന്റെ സ്ക്രീൻഷോട്ട് ഇവിടെ അയക്കുക തുടർന്ന് /bought command ന് മറുപടി നൽകുക.

വെരിഫിക്കേഷന് ശേഷം നിങ്ങളുടെ പ്രീമിയം പ്ലാൻ പ്രാബല്യത്തിൽ വരുന്നതാണ്.</b>"""
...
നിങ്ങൾ ഇന്ന് വെരിഫൈ ചെയ്തിട്ടില്ല, ദയവായി വെരിഫൈ ബട്ടൻ ക്ലിക്ക് ചെയ്യുക & ശേഷം നിങ്ങൾക്ക് പരിധിയില്ലാത്ത സേവനം അടുത്ത 4 മണിക്കൂർ വരെ ലഭിക്കുന്നതാണ്.
...
ഇനി അടുത്ത 4 മണിക്കൂർ നേരം പരിധിയില്ലാതെ ഈ bot നിങ്ങൾക്ക് ഉപയോഗിക്കാം.( WITHOUT ADS)
...
#verified_{}_completed"""
    ...
    MOVIES_UPDATE_TXT = """<b>#New_SERIAL_Added
